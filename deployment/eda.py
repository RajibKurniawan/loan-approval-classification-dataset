...
def run():
    ...
    # insight
    st.markdown(
        "Pemohon dengan rasio pinjaman terhadap pendapatan yang rendah dan skor kredit tinggi lebih sering disetujui. Grafik ini memperlihatkan interaksi antara dua fitur numerik terhadap target. jadi semakin besar pinjaman bisa saja salah satu faktor penolakan"
    )
